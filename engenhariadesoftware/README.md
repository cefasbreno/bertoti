...
### Tempo de implementação vs. qualidade do código:
Ao optar por se manter à frente da concorrência a todo custo exige atualizações constantes e profundas. Para isso, a qualidade do código é preterida para dar lugar a novas mecânicas, que acabam se tornando problemáticas com o tempo, necessitando de manutenções futuras.
